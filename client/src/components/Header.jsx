    ...
    <div className="heads">
        ...
        <div className="head">
          <div className="masonry">
            <div className="alert alert-primary text-center">Clothing</div>
            <img
            ...
            <br />
            <br />
            <a href="/clothing" className="btn btn-success buk ">
              explore
            </a>
            <br />
            <br />
          ...
          <div className="masonry">
            <div className="alert alert-primary text-center">Electronics</div>
            <img
            ...
            <br />
            <br />
            <a href="/ex" className="btn btn-success buk">
              explore
            </a>
            <br />
            <br />
          ...
          <div className="masonry">
            <div className="alert alert-primary text-center">Health and personal Care</div>
            <img
          ...
          <div className="masonry">
            <div className="alert alert-primary text-center">Gym/Fitness</div>
            <img
        ...
        <div className="head">
          <div className="masonry">
            <div className="alert alert-primary text-center">Kitchen</div>
            <img
            ...
            <br />
            <br />
            <a href="/kitchen" className="btn btn-success buk">
              explore
            </a>
            <br />
            <br />
          ...
          <div className="masonry">
            <div className="alert alert-primary text-center">Beauty Products</div>
            <img
            ...
            <br />
            <br />
            <a href="/beauty" className="btn btn-success buk">
              explore
            </a>
            <br />
            <br />
          ...
          <div className="masonry">
            <div className="alert alert-primary text-center">Gaming Accessories</div>
            <img
          ...
          <div className="masonry">
            <div className="alert alert-primary  text-center">Home/Office Furniture</div>
            <img
